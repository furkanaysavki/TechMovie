...
//  TechMovie
//
//  Created by Furkan Ayşavkı on 6.01.2023.
//
...
class TabBarVC: UITabBar {
    ...
    private func addShape() {
        ...
        shapeLayer.fillColor = UIColor(displayP3Red: 34/255, green: 47/255, blue: 62/255, alpha: 1.0).cgColor
        shapeLayer.lineWidth = 1.0
       //rgba(34, 47, 62,1.0)
        shapeLayer.shadowOffset = CGSize(width: 0, height: 0)
        shapeLayer.shadowRadius = 10
        shapeLayer.shadowColor = UIColor(displayP3Red: 34/255, green: 47/255, blue: 62/255, alpha: 1.0).cgColor
    ...
    override func draw(_ rect: CGRect) {
        ...
        self.tintColor = UIColor(displayP3Red: 87/255, green: 101/255, blue: 116/255, alpha: 1.0)
       //rgba(87, 101, 116,1.0)
    }
